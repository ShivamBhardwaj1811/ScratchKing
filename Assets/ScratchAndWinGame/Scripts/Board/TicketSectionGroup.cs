...
public class TicketSectionGroup : MonoBehaviour
{
    ...
    {
        winSettings = new WinSettings(Utility.RandomFromList(SettingsDatabase.instance.GoldPriceList), AreaType.Gold);
    }
    ...
    private IEnumerator BeginSectionGroupProcessing(Ticket ticket)
    {
        ...
        if (winSettings.type == AreaType.Gold) yield return ScoreBoardManager.instance.AnimNumberIn.Play();
